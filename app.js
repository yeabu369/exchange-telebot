...
const bot = new Telegraf('1353688196:AAFdoPz4zETGB2kega04LkVFFoPz0fOSxmw');

//method for invoking start command
 
bot.command('start', ctx => {
    console.log(ctx.from)
    bot.telegram.sendMessage(ctx.chat.id, 'Hello! I am BTC-ETB Order Bot. What is your name?', {
    })
});
